 ...
 * EmailNotificationEvent.welcome(user.getId(), user.getEmail(),
 * user.getUsername());
 *
 * // Fully custom
...
public record EmailNotificationEvent(
    ...
    public static EmailNotificationEvent welcome(UUID userId, String email, String username, String appName) {
        return builder()
                .correlationId(userId)
                .to(email)
                .recipientName(username)
                .subject("Welcome to " + appName)
                .htmlBody("<p>Welcome to " + appName + "! We're glad you're here.</p>")
                .eventType("WELCOME")
                .build();
    }
    ...
    public static final class Builder {
        ...
        public Builder correlationId(UUID v) {
        ...
        public Builder recipientName(String v) {
        ...
        public Builder htmlBody(String v) {
            this.htmlBody = v;
            return this;
        }

        public Builder textBody(String v) {
            this.textBody = v;
            return this;
        }
